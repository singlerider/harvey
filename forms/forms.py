...
class SurveyForm(Form):
    ...
    genres = SelectMultipleField('Genres', validators=[DataRequired()], option_widget=widgets.CheckboxInput(),
                                 ...
                                 choices=[
                                     ...
                                     ('Platformers', 'Platformers'), ('Puzzle',
                                                                      'Puzzle'), ('Racing', 'Racing'),
                                     ('Rogue-Like', 'Rogue-Like'), ('RPG',
                                                                    'Role-Playing Games'),
                                     ('Sandbox', 'Sandbox'),
                                     ('Simulation', 'Simulation'), ('Social',
                                                                    'Social/Casual'),
                                     ('Sports', 'Sports'),
                                     ('Strategy', 'Strategy/4X'), ('TPS',
    ...
    hours = RadioField('On average, how many hours do you play games each week?', validators=[DataRequired()],
                       choices=[
                           ('6', '6 hours or less'), ('13',
                                                      '7-13 hours'), ('20', '14-20 hours'),
